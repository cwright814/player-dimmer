...
# Path to Moonrise (contains Minecraft source in Fabric's loom cache)
MOONRISE="../Moonrise"

# Gradle Cache Dependencies (build Moonrise to generate)
...
# Collect classpath
CP="$MOONRISE/.gradle/loom-cache/minecraftMaven/net/minecraft/minecraft-merged-2ffda7bfea/26.1.2/minecraft-merged-2ffda7bfea-26.1.2.jar"
CP="$CP:$GRADLE_CACHE/net.fabricmc/fabric-loader/$FABRIC_LOADER.jar"
CP="$CP:$GRADLE_CACHE/net.fabricmc/sponge-mixin/$SPONGE_MIXIN.jar"
CP="$CP:$GRADLE_CACHE/com.google.code.gson/gson/$GSON.jar"
CP="$CP:$GRADLE_CACHE/org.jspecify/jspecify/$JSPECIFY.jar"
CP="$CP:$GRADLE_CACHE/com.mojang/brigadier/$BRIGADIER.jar"
CP="$CP:$GRADLE_CACHE/it.unimi.dsi/fastutil/$FASTUTIL.jar"
CP="$CP:libs/cloth-config-26.1.154.jar"
CP="$CP:libs/modmenu-18.0.0.jar"

JAVA_HOME="$HOME/.local/share/PandoraLauncher/runtime/graalvm-25.1.3/linux"
